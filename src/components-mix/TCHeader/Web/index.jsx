...
import { WebHeader } from "@/constants";
    ...
    >
      <Container>
        ...
        >
          ...
          >
            <div className={clsx(styles.logoWrapper, "align-self-center")}>
              <Image
                width="100%"
                height="100%"
                src={Logo}
          ...
          <div className="d-flex align-items-center justify-content-end header-right-side gap-5">
            <TCButton variant={"default"}>Log in</TCButton>
            <TCButton variant={"primary"}>Register</TCButton>
